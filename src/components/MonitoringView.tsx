        ...
        sections={[
          {
            ...
            items: [
              ...
              "If you choose Custom, define your own start time, end time, and interval (15 min, 30 min, 1 hour, or 2 hours) in the header bar, then click Generate Table to create the rows.",
            ],
          },
          {
          ...
          },
          {
            ...
            items: [
              "SKUs for the shift auto-populate at the top of the board from the active job snapshots in the database.",
              "Print Report - prints the full shift report as a PDF (help guide and edit fields are excluded).",
              "Export CSV - downloads the shift board data as a CSV file you can open in Excel.",
